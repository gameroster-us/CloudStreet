require "fog/aws/requests/compute/authorize_security_group_egress"
require "fog/aws/requests/compute/revoke_security_group_egress"
module Fog
  module AWS
    class Compute
      class SecurityGroup < Fog::Model
        ...
        def authorize_egress_port_range(range, options = {})
          requires_one :name, :group_id
        ...
        def revoke_egress_port_range(range, options = {})
          requires_one :name, :group_id
