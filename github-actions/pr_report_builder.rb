...
class PrReportBuilder
  ...
  class << self
    ...
    def column_check(location)
      ...
      is_change_require = (same_line && has_columns && location["start_column"] > location["last_column"])
      location["start_column"], location["last_column"] = location["last_column"], location["start_column"] if is_change_require
