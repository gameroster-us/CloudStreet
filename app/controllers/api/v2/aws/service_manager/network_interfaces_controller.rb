class Api::V2::AWS::ServiceManager::NetworkInterfacesController < Api::V2::ServiceManagerBaseController
  ...
  def index
    ServiceManagerService.list_services_details(current_account, current_tenant, service_manager_params) do |result|
      result.on_success { |service_manager| respond_with_user_and service_manager, represent_with: V1::ServiceManagersRepresenter }
  ...
  def service_manager_params
    params[:type] = "Services::Network::NetworkInterface::AWS"
