class ProviderWrappers::Azure::Databases::Mariadb::ServerProvider < ProviderWrappers::Azure
  ...
  def update_tags(resource_group_name, server_name, parameters)
    parameters = build_model(Azure::MariaDB::Profiles::Latest::Mgmt::Models::Server, parameters)
