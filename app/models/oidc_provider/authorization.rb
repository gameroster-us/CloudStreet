...
class OIDCProvider::Authorization < ApplicationRecord
  belongs_to :account, class_name: "User"
  has_one :access_token, class_name: "OIDCProvider::AccessToken", dependent: :destroy
  has_one :id_token, class_name: "OIDCProvider::IdToken", dependent: :destroy
